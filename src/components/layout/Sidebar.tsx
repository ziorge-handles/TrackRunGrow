...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/dashboard/lineups', label: 'Lineups', icon: ListChecks },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/tracking', label: 'Tracking Lists', icon: Tag },
  ...
  },
  {
    title: 'Data',
    items: [
      { href: '/dashboard/import-export', label: 'Import / Export', icon: ArrowDownUp },
      { href: '/dashboard/settings', label: 'Settings', icon: Settings },
      { href: '/dashboard/settings/security', label: 'Security & MFA', icon: Lock },
    ],
  },
]
